...
namespace SkillChallenge.Interfaces
{
    public interface ISubCategoryRepository
    {
        ...
        Task<SubCategory> CreateSubCategoryAsync(SubCategory subCategory, CancellationToken ct = default);
        Task<SubCategory?> UpdateSubCategoryAsync(int id, SubCategory updatedSubCategory, CancellationToken ct = default);
